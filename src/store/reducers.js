...
export const exchange = (state = { loaded: false, contract: {}, transaction: { isSuccessful: false}, allOrders: {loaded: false, data: []}, cancelledOrders: {data: []}, filledOrders: {data: []}, events: [] }, action) => {
	let index, data
	switch (action.type) {
